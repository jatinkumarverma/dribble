      ...
      <nav className='hidden mx-8 lg:flex items-center justify-between'>
        ...
        <div className='flex space-x-4'>
          <div className="relative flex items-center w-full max-w-md bg-white rounded-full overflow-hidden">
            <input
              type='text'
              className="w-[277px] h-[45px] bg-[#ebebf2] rounded-full border-[#FFECC6] pl-10 pr-4 py-2 placeholder:pl-2 font-Lato font-normal text-[14px] leading-[18px] text-[#868686] hover:bg-white hover:border-[6px]"
              placeholder='Search...'
            />
          ...
          <div className='flex space-x-2'>
            <button className='w-24 py-2 bg-gray-200 text-black font-semibold rounded-full'>Sign in</button>
      ...
      <div className='flex lg:hidden items-center m-4'>
        ...
        <div className='ml-auto flex space-x-4'>
          ...
          <div className='flex space-x-2'>
            ...
            <button className='w-16 py-2 bg-[#000000] text-white font-semibold rounded-md text-[10px]'>Sign up</button>
          </div>
        </div>
      </div>
